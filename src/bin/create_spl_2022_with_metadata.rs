...
fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    // endregion:    -- 7. Send transaction

    // FIXME: Look into the Rust version of getMint() & getMetadataPointerState(getMint())
    // https://github.com/solana-labs/solana-program-library/blob/master/token-metadata/example/tests/update_field.rs

    Ok(())
}

// -- Successful output log using CLI `spl-token display
// Ev4cCgvsRBuUdVs22MBt6N5ancPhXWLKbc5Puzd1uoMB`:
// SPL Token Mint
//   Address: Ev4cCgvsRBuUdVs22MBt6N5ancPhXWLKbc5Puzd1uoMB
//   Program: TokenzQdBNbLqP5VEhdkAS6EPFLC1PHnBqCXEpPxuEb
//   Supply: 0
//   Decimals: 2
//   Mint authority: Bgxi9HXC3Ug4BiLGkADUUtQewjprG1sLzuKeNix31BfC
//   Freeze authority: (not set)
// Extensions
//   Metadata Pointer:
//     Authority: Bgxi9HXC3Ug4BiLGkADUUtQewjprG1sLzuKeNix31BfC
//     Metadata address: Ev4cCgvsRBuUdVs22MBt6N5ancPhXWLKbc5Puzd1uoMB
//   Metadata:
//     Update Authority: Bgxi9HXC3Ug4BiLGkADUUtQewjprG1sLzuKeNix31BfC
//     Mint: Ev4cCgvsRBuUdVs22MBt6N5ancPhXWLKbc5Puzd1uoMB
//     Name: Token22 Name
//     Symbol: Token22 Symbol
//     URI: Token22 Uri
//     key1: value1
